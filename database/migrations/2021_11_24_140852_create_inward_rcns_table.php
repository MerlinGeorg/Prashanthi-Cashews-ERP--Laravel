...
class CreateInwardRcnsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('inward_rcns', function (Blueprint $table) {
            $table->id();
            $table->string('slug');
            $table->string('stockyard_slug');
            ...
            $table->date('dispatched_date_time');
            $table->date('received_date_time');
    ...
    {
        Schema::dropIfExists('inward_rcns');
    }
}
