...
<div class="main-menu menu-fixed {{ $configData['theme'] === 'dark' || $configData['theme'] === 'semi-dark' ? 'menu-dark' : 'menu-light' }} menu-accordion menu-shadow"
    ...
    <div class="main-menu-content pt-1">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            @if (isset($menuData[\Auth::user()->work_location_type]))
                @foreach ($menuData[\Auth::user()->work_location_type]->menu as $menu)
                    @php
                        $custom_classes = '';
                    ...
                    @endphp
                    @if (Helper::isMenuEnabled(\Auth::user()->work_location_type, $menu->name))
                        <li class="nav-item @if (isset($menu->submenu)){{ 'dropdown' }}@endif {{ $custom_classes }} {{ Helper::activeMenuBySlug($menu->slug) ? 'active' : '' }}"
