@if ($configData['mainLayoutType'] === 'horizontal' && isset($configData['mainLayoutType']))
    ...
    @else
        <nav
            class="header-navbar navbar navbar-expand-lg align-items-center navbar-light navbar-shadow {{ $configData['navbarColor'] }} {{ $configData['layoutWidth'] === 'boxed' && $configData['verticalMenuNavbarType'] === 'navbar-floating' ? 'fixed-top' : 'fixed-top' }}">
@endif
      ...
      <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
        ...
        <li class="nav-item dropdown dropdown-user">
            <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);"
                ...
                <span class="avatar">
                    <img class="round" {{-- src="{{ Auth::user()->profile_image ? Storage::url(Auth::user()->profile_image) : asset('images/avatars/profile-placeholder.png') }}" --}}
                        src="
                        {{ // Storage::exists(Auth::user()->profile_image) ? Storage::url(Auth::user()->profile_image) :
                            asset('images/avatars/profile-placeholder.png') }}"
            ...
            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
                <div class="user-nav d-sm-flex d-none">
                    ...
                    <span class="user-status small py-50">
                        {{ config('constants.work_location_types')[Auth::user()->work_location_type] ?? '' }} Staff
                    </span>
                </div>
