...
@section('title', 'Add Sizering Stock')
    ...
    <section id="multiple-column-form">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('factory.sizering.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="mb-1 col-md-3">
                                    <label class="form-label" for="factory_stock_slug">Lot Number<label
                                            class="text-danger px-sm-25"> *</label></label>
                                    <select class="form-select select2" name="factory_stock_slug" id="factory_stock_slug"
                                        value="{{ old('factory_stock_slug') }}">
                                        <option value="">Select</option>
                                    </select>
                                ...
                                <div class="mb-1 col-md-3">
                                    ...
                                    <input type="text" name="sizering_date_time" id="sizering_date_time"
                                        value="{{ old('sizering_date_time') }}"
                                        class="form-control flatpickr-sizer-date-time" placeholder="DD-MM-YYYY HH:II" />
                            ...
                            <div class="row border p-1 m-0 col-md-6">
                                <div class="mb-1 col-md-6">
                                    <label class="form-label" for="rcn_weight">RCN Weight<label
                                            class="text-danger px-sm-25"> *</label></label>
                                    <input type="text" placeholder="in Kgs" step="0.01" name="rcn_weight" id="rcn_weight"
                                        value="{{ old('rcn_weight') }}" class="form-control number-mask" maxlength="6" />
                                    @error('rcn_weight')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="mb-1 col-md-6">
                                    <label class="form-label" for="rcn_bag">RCN Bag<label class="text-danger px-sm-25">
                                            *</label></label>
                                    <input type="text" step="0.01" placeholder="in Bags" name="rcn_bag" id="rcn_bag"
                                        value="{{ old('rcn_bag') }}" class="form-control number-mask" maxlength="6" />
                                    @error('rcn_bag')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-11 border row m-1 p-1 mr-0">
                                    ...
                                    <div class="mb-1 col-md-2">
                                        ...
                                        <input type="text" placeholder="in Kgs" step="0.01"
                                            ...
                                            value="{{ old('foreign_matter_total_weight') }}"
                                            class="form-control number-mask" maxlength="6" />
...
@section('page-script')
    ...
    <script>
        let selectedStock = "{{ old('factory_stock_slug') }}";
        getfactoryofchange();
