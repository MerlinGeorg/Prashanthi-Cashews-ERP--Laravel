                                            ...
                                            <div class="mb-1 col-md-6">
                                                ...
                                                <select class="form-control select2" name="religion" id="religion">
                                                    ...
                                                    @foreach ($religions as $slug => $religion)
                                                        <option @if ($slug == $employee->religion) selected @endif
                                                            value="{{ $slug }}">
                                                            {{ $religion }}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="mb-1 col-md-6">
                                                ...
                                                <select class="form-control select2" name="nationality" id="nationality">
                                                    ...
                                                    @foreach ($nationalities as $slug => $nationality)
                                                        <option @if ($slug == $employee->nationality) selected @endif
                                                            value="{{ $slug }}">
                                                            {{ $nationality }}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="mb-1 col-md-6">
                                                ...
                                                <select class="form-control select2" name="status" id="status">
                                                    @foreach ($statuses as $slug => $status)
                                                        <option @if ($slug == $employee->status) selected @endif
                                                            value="{{ $slug }}">
                                                            {{ $status }}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="mb-1 col-md-6">
                                                ...
                                                <select class="form-control select2" name="work_location_type"
                                                    ...
                                                    @foreach ($work_location_types as $key => $name)
                                                        <option @if ($employee->work_location_type == $key) selected @endif
                                                            value="{{ $key }}">
                                                            {{ $name }}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="mb-1 col-md-6">
                                                ...
                                                <select class="form-control select2" name="job_category" id="job_category">
                                                    ...
                                                    @foreach ($job_categories as $key => $name)
                                                        <option @if ($employee->job_category == $key) selected @endif
                                                            value="{{ $key }}">
                                                            {{ $name }}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-6 mb-1">
                                                ...
                                                <select class="form-control select2" name="state" id="state">
                                                    ...
                                                    @foreach ($states as $slug => $state)
                                                        <option @if ($slug == $employee->state) selected @endif
                                                            value="{{ $slug }}">
                                                            {{ $state }}</option>
                                                    @endforeach
                                                </select>
