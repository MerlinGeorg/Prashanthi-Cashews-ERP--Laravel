                                            ...
                                            <div class="mb-1 col-md-6">
                                                ...
                                                <select class="form-control select2" name="religion" id="religion">
                                                    ...
                                                    @foreach ($religions as $slug => $religion)
                                                        <option value="{{ $slug }}">{{ $religion }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            ...
                                            <div class="mb-1 col-md-6">
                                                ...
                                                <select class="form-control select2" name="nationality" id="nationality">
                                                    ...
                                                    @foreach ($nationalities as $slug => $nationality)
                                                        <option value="{{ $slug }}">{{ $nationality }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <div id="company-info" class="content" role="tabpanel"
                                    ...
                                    <form>
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 form-group">
                                                <label class="d-block mb-1">Job Type <label class="text-danger px-sm-25">
                                                        *</label></label>
                                    ...
                                    <form>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-1">
                                                <label class="form-label" for="mobile">Mobile Number</label><span
                                                    class="text-danger px-sm-25"> *</span>
                                            ...
                                            <div class="col-md-6 mb-1">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <input type="text" name="whatsapp" id="whatsapp"
                                                        class="form-control number-mask" minlength="10" maxlength="10" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-1">
                                                <label class="form-label" for="address_line_1">Address Line
                                                    1</label><span class="text-danger px-sm-25"> *</span>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-1">
                                                <label class="form-label" for="city">City</label><span
                                                    class="text-danger px-sm-25"> *</span>
                                                <input type="text" name="city" id="city" class="form-control"
                                                    maxlength="30" />
                                            </div>
                                            <div class="col-md-6 mb-1">
                                                <label class="form-label" for="district">District</label><span
                                                    class="text-danger px-sm-25"> *</span>
                                            ...
                                            <div class="col-md-6 mb-1">
                                                ...
                                                <select class="form-control select2" name="state" id="state">
                                                    ...
                                                    @foreach ($states as $slug => $state)
                                                        <option value="{{ $slug }}">{{ $state }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-md-6 mb-1">
                                                <label class="form-label" for="pincode">Pincode</label><span
                                                    class="text-danger px-sm-25"> *</span>
...
@section('page-script')
    ...
    <script src="{{ asset(mix('js/scripts/app/factory/employee/create.js')) }}"></script>
    <script src="{{ asset(mix('js/scripts/forms/form-input-mask.js')) }}"></script>
    <script>
        $(document).ready(function() {
            fetchWorkLocation($("#work_location_type").val());

            $("#nationality").val("indian").select2();
        });
    </script>
@endsection
