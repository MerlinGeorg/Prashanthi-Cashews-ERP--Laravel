                            ...
                            <div class="row">
                                ...
                                <div class="mb-1 col-md-6">
                                    <label class="form-label" for="bl_despatched_rcn_weight">BL Despatched RCN Weight
                                        (Kg)</label>
                                    <input type="text" maxlength="10" name="bl_despatched_rcn_weight"
                                        id="bl_despatched_rcn_weight"
                                ...
                                <div class="mb-1 col-md-6">
                                    <label class="form-label" for="bl_despatched_rcn_bags">BL Despatched RCN
                                        Bags</label>
                                    <input type="text" maxlength="10" name="bl_despatched_rcn_bags"
                                        id="bl_despatched_rcn_bags"
                                        value="{{ $stockyard_rcn_data->bl_despatched_rcn_bags }}"
                                        class="form-control number-mask" />
                                ...
                                <div class="mb-1 col-md-6">
                                    ...
                                    <input type="text" maxlength="10" name="nut_count" id="nut_count"
                                        value="{{ $stockyard_rcn_data->nut_count }}" class="form-control number-mask " />
                                    @error('nut_count')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
