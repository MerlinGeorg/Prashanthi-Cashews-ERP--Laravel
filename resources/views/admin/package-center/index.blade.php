...
@section('title', 'Package Center List')
                        ...
                        <div class="card-header border-bottom p-1">
                            ...
                            <div class="dt-action-buttons align-items-end">
                                <div class="dt-buttons d-inline-flex">
                                    <a href="{{ route('admin.package-center.create') }}"
...
@section('page-script')
    {{-- Page js files --}}
    <script src="{{ asset(mix('js/scripts/app/package-center/list.js')) }}"></script>
