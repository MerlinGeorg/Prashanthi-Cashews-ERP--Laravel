...
@section('title', 'Edit Package Center')
    ...
    <section id="multiple-column-form">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('package-center.update', $package_center->slug) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="mb-1 col-md-6">
                                    ...
                                    <input type="text" maxlength="32" name="package_center_name" id="package_center_name"
                                        value="{{ old('package_center_name', $package_center->package_center_name) }}"
                                        class="form-control" />
                                ...
                                <div class="mb-1 col-md-6">
                                    ...
                                    <input type="text" maxlength="32" name="package_center_short_name"
                                        id="package_center_short_name"
                                        value="{{ old('package_center_short_name', $package_center->package_center_short_name) }}"
                                        class="form-control" />
                                ...
                                <div class="mb-1 col-md-6">
                                    ...
                                    <select class="form-select select2" name="package_center_office_slug"
                                        id="package_center_office_slug"
                                        value="{{ old('package_center_office_slug', $package_center->package_center_office_slug) }}">
                                        <option value="">Select</option>
                                        @if ($offices)
                                            @foreach ($offices as $office)
                                                @if ($package_center->office->slug == $office->slug)
                                ...
                                <div class="mb-1 col-md-6">
                                    ...
                                    <input type="text" maxlength="32" name="package_center_reg_number"
                                        id="package_center_reg_number"
                                        value="{{ old('package_center_reg_number', $package_center->package_center_reg_number) }}"
                                        class="form-control" />
                                ...
                                <div class="mb-1 col-md-6">
                                    ...
                                    <select class="form-select select2 state_account"
                                        onchange="getstateaccounts('{{ old('package_center_sub_account_slug', $package_center->package_center_sub_account_slug) }}')"
                                        ...
                                        @if (config('constants.states'))
                                            @foreach (config('constants.states') as $state)
                                                @if ($state == old('package_center_state', $package_center->package_center_state))
                                ...
                                <div class="mb-1 col-md-6">
                                    ...
                                    <select class="form-select select2 state_account_list"
                                        ...
                                        value="{{ old('package_center_sub_account_slug', $package_center->package_center_sub_account_slug) }}">
                                        <option value="">Select</option>
                                        <!-- @if ($accounts)
                                ...
                                <div class="mb-1 col-md-6">
                                    ...
                                    <input type="text" name="package_center_power_allocation"
                                        ...
                                        value="{{ old('package_center_power_allocation', $package_center->package_center_power_allocation) }}"
                                ...
                                <div class="mb-1 col-md-6">
                                    <label class="form-label" for="package_center_location">Location<label
                                            ...
                                            *</label></label>
                                    <input type="text" maxlength="128" name="package_center_location"
                                        id="package_center_location"
                                        value="{{ old('package_center_location', $package_center->package_center_location) }}"
                                        class="form-control" />
                                ...
                                <div class="mb-1 col-md-6">
                                    ...
                                    <input type="text" maxlength="128" name="package_center_contact_address_1"
                                        ...
                                        value="{{ old('package_center_contact_address_1', $package_center->package_center_contact_address_1) }}"
                                        class="form-control" />
                                ...
                                <div class="mb-1 col-md-6">
                                    <label class="form-label" for="package_center_contact_address_2">Address Line
                                        2</label>
                                    <input type="text" maxlength="128" name="package_center_contact_address_2"
                                        id="package_center_contact_address_2"
                                        value="{{ old('package_center_contact_address_2', $package_center->package_center_contact_address_2) }}"
                                        class="form-control" />
                                ...
                                <div class="mb-1 col-md-6">
                                    ...
                                    <input type="text" maxlength="6" name="package_center_pincode"
                                        id="package_center_pincode"
                                        value="{{ old('package_center_pincode', $package_center->package_center_pincode) }}"
...
@section('page-script')
    ...
    <script>
        let account_slug =
            "{{ old('package_center_sub_account_slug', $package_center->package_center_sub_account_slug) }}";
