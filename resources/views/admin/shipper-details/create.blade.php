...
@section('title', 'Add Shipper Details')
    ...
    <section id="multiple-column-form">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.shipper-details.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="row">
                                <div class="mb-1 col-md-6">
                                    ...
                                    <input type="text" maxlength="32" name="shipper_company_name" id="shipper_company_name"
                                        value="{{ old('shipper_company_name') }}" class="form-control" />
                                ...
                                <div class="mb-1 col-md-6">
                                    ...
                                    <input type="text" maxlength="32" name="shipper_location" id="shipper_location"
                                        value="{{ old('shipper_location') }}" class="form-control" />
                                ...
                                <div class="mb-1 col-md-6">
                                    ...
                                    <input type="text" maxlength="128" name="shipper_contact_address_1"
                                        id="shipper_contact_address_1" value="{{ old('shipper_contact_address_1') }}"
                                        class="form-control" />
                                ...
                                <div class="mb-1 col-md-6">
                                    ...
                                    <input type="text" maxlength="128" name="shipper_contact_address_2"
                                        id="shipper_contact_address_2" value="{{ old('shipper_contact_address_2') }}"
                                        class="form-control" />
