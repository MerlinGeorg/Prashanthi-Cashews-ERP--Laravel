    ...
    <section id="multiple-column-form">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.stockyard.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="row">
                                <div class="mb-1 col-md-6">
                                    ...
                                    <input type="text" maxlength="32" name="stockyard_name" id="stockyard_name"
                                        value="{{ old('stockyard_name') }}" class="form-control" />
                                ...
                                <div class="mb-1 col-md-6">
                                    <label class="form-label" for="stockyard_short_name">Short Name<label
                                            class="text-danger px-sm-25"> *</label></label>
                                    <input type="text" maxlength="20" name="stockyard_short_name" id="stockyard_short_name"
                                        value="{{ old('stockyard_short_name') }}" class="form-control" />
                                ...
                                <div class="mb-1 col-md-6">
                                    ...
                                    <select class="form-select select2" name="office_slug" id="office_slug"
                                        value="{{ old('office_slug') }}">
                                        <option value="">Select</option>
                                        @if ($offices)
                                            @foreach ($offices as $office)
                                                @if ($office->slug == old('office_slug'))
                                ...
                                <div class="mb-1 col-md-6">
                                    ...
                                    <input type="text" maxlength="32" name="stockyard_reg_number" id="stockyard_reg_number"
                                        value="{{ old('stockyard_reg_number') }}" class="form-control" />
                                ...
                                <div class="mb-1 col-md-6">
                                    ...
                                    <select class="form-select select2 state_account" onchange="getstateaccounts()"
                                        name="stockyard_state" id="stockyard_state" value="{{ old('stockyard_state') }}">
                                        <option value="">Select</option>
                                        @if (config('constants.states'))
                                            @foreach (config('constants.states') as $state)
                                                @if ($state == old('stockyard_state'))
                                ...
                                <div class="mb-1 col-md-6">
                                    ...
                                    <select class="form-select select2 state_account_list" name="sub_account_slug"
                                        id="sub_account_slug" value="{{ old('sub_account_slug') }}"
                                        data-selected="{{ old('sub_account_slug') }}">
                                        <option value="">Select</option>
                                        @if ($accounts)
                                ...
                                <div class="mb-1 col-md-6">
                                    <label class="form-label" maxlength="128" for="contact_address_1">Address Line
                                        1<label class="text-danger px-sm-25"> *</label></label>
                                    <input type="text" name="contact_address_1" id="contact_address_1"
                                        value="{{ old('contact_address_1') }}" class="form-control" />
                                ...
                                <div class="mb-1 col-md-6">
                                    ...
                                    <input type="text" name="contact_address_2" id="contact_address_2"
                                        value="{{ old('contact_address_2') }}" class="form-control" />
                                ...
                                <div class="mb-1 col-md-6">
                                    ...
                                    <input type="text" maxlength="6" name="stockyard_pincode" id="stockyard_pincode"
                                        value="{{ old('stockyard_pincode') }}" class="form-control pincode-mask" />
                                ...
                                <?php
                                $warehouse_val_count = old('warehouse') ? sizeof(old('warehouse')) : 1;
                                ?>
                                                                    ...
                                                                    <div class="col-md-6 col-12">
                                                                        <div class="mb-1">
                                                                            ...
                                                                            <input type="text" maxlength="128"
                                                                                ...
                                                                                value="{{ old('warehouse.' . $i . '.warehouse_name') }}"
                                                                    ...
                                                                    <div class="col-md-5 col-12">
                                                                        <div class="mb-1">
                                                                            ...
                                                                            <select
                                                                                ...
                                                                                data-selected="{{ old('warehouse.' . $i . '.warehouse_account_slug') }}">
                                                                                <option value="">Select</option>
