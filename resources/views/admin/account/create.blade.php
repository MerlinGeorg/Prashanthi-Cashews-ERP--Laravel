                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.account.store') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-1 col-md-6">
                                    ...
                                    <input type="text" maxlength="32" name="account_short_name" id="account_short_name"
                                        value="{{ old('account_short_name') }}" class="form-control" />
                            ...
                            <?php
                            $state_val_count = old('state_account') ? sizeof(old('state_account')) : 1;
                            ?>
                                                                ...
                                                                <div class="col-md-6 col-12">
                                                                    <div class="mb-1">
                                                                        ...
                                                                        <select class="form-select select2"
                                                                            ...
                                                                            value="{{ old('state_account.' . $i . '.account_state') }}">
                                                                            <option value="">Select</option>
                                                                            @if (config('constants.states'))
                                                                                @foreach (config('constants.states') as $state)
                                                                                    @if ($state == old('state_account.' . $i . '.account_state'))
                                                                                        <option value="{{ $state }}"
                                                                                            selected>{{ $state }}
                                                                                        </option>
                                                                                    @else
                                                                ...
                                                                <div class="col-md-5 col-12">
                                                                    <div class="mb-1">
                                                                        ...
                                                                        <input type="text" maxlength="128"
                                                                            ...
                                                                            value="{{ old('state_account.' . $i . '.account_gst') }}"
                                                                            class="form-control" />
                                                                ...
                                                                <div class="col-md-6 col-12">
                                                                    <div class="mb-1">
                                                                        ...
                                                                        <input type="text" maxlength="128"
                                                                            ...
                                                                            value="{{ old('state_account.' . $i . '.account_address_1') }}"
                                                                            class="form-control" />
                                                                ...
                                                                <div class="col-md-5 col-12">
                                                                    <div class="mb-1">
                                                                        ...
                                                                        <input type="text" maxlength="128"
                                                                            ...
                                                                            value="{{ old('state_account.' . $i . '.account_address_2') }}"
                                                                            class="form-control" />
