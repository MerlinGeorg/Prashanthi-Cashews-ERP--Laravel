                            ...
                            <div class="row">
                                ...
                                <div class="mb-1 col-md-6">
                                    ...
                                    <input type="text" maxlength="32" name="factory_short_name" id="factory_short_name"
                                        value="{{ old('factory_short_name') }}" class="form-control" />
                                    @error('factory_short_name')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="mb-1 col-md-6">
                                    <label class="form-label" for="factory_reg_number">
                                        Registration / Door No <label class="text-danger px-sm-25"> *</label></label>
                                    <input type="text" name="factory_reg_number" id="factory_reg_number" maxlength="32"
                                        value="{{ old('factory_reg_number') }}" class="form-control" />
                                ...
                                <div class="mb-1 col-md-6">
                                    ...
                                    <input type="text" maxlength="32" name="factory_location" id="factory_location"
                                        value="{{ old('factory_location') }}" class="form-control" />
                                ...
                                <div class="mb-1 col-md-6">
                                    ...
                                    <select class="form-select select2" name="factory_office_slug" id="factory_office_slug"
                                        value="{{ old('factory_office_slug') }}">
                                        <option value="">Select</option>
                                        @if ($offices)
                                            @foreach ($offices as $office)
                                                @if ($office->slug == old('factory_office_slug'))
                                ...
                                <div class="mb-1 col-md-6">
                                    ...
                                    <select class="form-select select2 state_account"
                                        onchange="getstateaccounts('{{ old('factory_sub_account_slug') }}')"
                                        name="factory_state" id="factory_state" value="{{ old('factory_state') }}">
                                        <option value="">Select</option>
                                        @if (config('constants.states'))
                                            @foreach (config('constants.states') as $state)
                                                @if ($state == old('factory_state'))
                                ...
                                <div class="mb-1 col-md-6">
                                    ...
                                    <select class="form-select select2 state_account_list" name="factory_sub_account_slug"
                                        id="factory_sub_account_slug" value="{{ old('factory_sub_account_slug') }}">
                                        <option value="">Select</option>
                                        <!-- @if ($accounts)
                                ...
                                <div class="mb-1 col-md-6">
                                    ...
                                    <input type="text" name="factory_power_allocation" id="factory_power_allocation"
                                        placeholder="K V" value="{{ old('factory_power_allocation') }}"
                                ...
                                <div class="mb-1 col-md-6">
                                    ...
                                    <input type="text" name="factory_contact_address_1" id="factory_contact_address_1"
                                        value="{{ old('factory_contact_address_1') }}" class="form-control" />
                                ...
                                <div class="mb-1 col-md-6">
                                    ...
                                    <input type="text" name="factory_contact_address_2" id="factory_contact_address_2"
                                        value="{{ old('factory_contact_address_2') }}" class="form-control" />
                                ...
                                <div class="mb-1 col-md-6">
                                    ...
                                    <input type="text" maxlength="6" name="factory_pincode" id="factory_pincode"
                                        value="{{ old('factory_pincode') }}" class="form-control pincode-mask" />
                                ...
                                <div class="row processing_type_div">
                                    ...
                                    @foreach (config('constants.processing_types') as $key => $processing_type)
                                        ...
                                        $checked_val = isset($old_val) ? 'checked' : '';
                                        $disabled_checkbox = old('factory_of') == 'Prashanthi' ? '' : 'disabled';
                                            ...
                                            <div class="mb-1">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        value="{{ old('processor_types_list.' . $key . '.processing_capacity') }}"
...
@section('page-script')
    ...
    <script>
        let account_slug = "{{ old('factory_sub_account_slug') }}";
