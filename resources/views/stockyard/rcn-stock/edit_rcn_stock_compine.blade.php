...
@section('title', 'Edit RCN Stock - Combine')
    ...
    <section id="multiple-column-form">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('stockyard.rcn-stocks.updateCompine', $stockyard_rcn_data->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                ...
                                <div class="mb-1 col-md-6">
                                    <label class="form-label" maxlength="32" for="rcn_mark">RCN Mark<label
                                            class="text-danger px-sm-25"> *</label></label>
                                                <span class="form-control" >{{ $stockyard_rcn_data->rcn_mark }}</span>
