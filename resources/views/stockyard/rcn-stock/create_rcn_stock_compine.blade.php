...
@section('title', 'Add RCN Stock - Combine')
...
<section id="multiple-column-form">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('stockyard.rcn-stock.store_compine') }}" method="POST">
                        @csrf
                        <input type="hidden" name="type" id="type" value="combine"  />
...
<script src="{{ asset(mix('js/scripts/app/stockyard/compine/compine.js')) }}"></script>
<script src="{{ asset(mix('js/scripts/app/stockyard/compine/form-repeater.js')) }}"></script>
