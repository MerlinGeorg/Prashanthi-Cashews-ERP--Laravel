...
@section('title', 'View RCN Stock - Split')
@section('content')
                        ...
                        <div class="dt-action-buttons text-end">
                            <div class="dt-buttons d-inline-flex">
                                ...
                                @if (\Helper::userAccess('stockyard-rcn-edit'))
                                    <a href="{{ route('stockyard.rcn-stock.edit_split', $stockyard_rcn_data->slug) }}"
                            ...
                            <div class="row mt-1">
                                ...
                                <div class="mb-1 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <span type="number" name="rcn_bags" id="rcn_bags" 
                                        class="form-control number-mask">
                                ...
                                <div class="mb-1 col-md-6">
                                    <label class="form-label" for="lot_number">Parent Lot No.</label>
