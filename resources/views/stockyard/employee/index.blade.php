                ...
                <div class="card">
                    <div class="card-header flex-row justify-content-between">
                        ...
                        <div class="">
                            ...
                            <p class="card-text">Active Employee</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-header flex-row justify-content-between">
                        ...
                        <div class="">
                            ...
                            <p class="card-text">Pending Employee</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-header flex-row justify-content-between">
                        ...
                        <div class="">
                            ...
                            <p class="card-text">Inactive Employee</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-header border-bottom p-1">
                            ...
                            <div class="dt-action-buttons text-end">
                                <div class="dt-buttons d-inline-flex">
                                    <a href="{{ route('stockyard.employee.create') }}" class="dt-button btn btn-primary">
...
@section('page-script')
    <!-- Page js files -->
    <script src="{{ asset(mix('js/scripts/app/stockyard/employee/list.js')) }}"></script>
