...
@section('content')
                ...
                <div class="bs-stepper-content px-0 mt-0 pt-0">
                    ...
                    <div id="personal-info" class="content" role="tabpanel" aria-labelledby="personal-info-trigger">
                        ...
                        <form>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-1">
                                    <label class="form-label" for="password">Password<span class="text-danger px-sm-25">
                                            *</span></label>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-1">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" name="mobile" id="mobile" class="form-control number-mask"
                                            maxlength="10" />
                                    </div>
                                </div>
                                <div class="col-md-6 mb-1">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <span class="input-group-text">IN (+91)</span><input type="text" name="whatsapp"
                                            id="whatsapp" class="form-control number-mask" maxlength="10" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
    ...
    <input type="hidden" id="redirect-to" value="{{ route('staff-register') }}">
@endsection
