                    ...
                    render: function (data, type, full, meta) {
                        ...
                        if (full['action']['view']) {
                            action += '<a class="me-1" href="' +
                                        assetPath + 'stockyard/employee/' + full['slug'] +
                                        '" title="View Employee">' +
                                        feather.icons['eye'].toSvg({ class: 'font-medium-2 text-body' }) +
                                        '</a> ';
                        }
                        if (full['action']['edit']) {
                            action += '<a class="" href="' + assetPath + 'stockyard/employee/' + full['slug'] + '/edit' + '" title="Edit Employee">' +
