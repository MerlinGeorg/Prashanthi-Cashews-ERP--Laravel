    ...
    if (dtInvoiceTable.length) {
        var dtInvoice = dtInvoiceTable.DataTable({
            ...
            columns: [
                ...
                { data: 'name', name: 'name' },
                { data: 'slug', name: 'slug' },
                { data: 'resource_slug', name: 'resource_slug' },
            ...
            columnDefs: [
                ...
                if (full['action']['edit']) {
                    action += '<a class="me-1" href="' + assetPath + 'admin/permission/' + full['slug'] + '/edit' + '" title="Edit permission">' +
                            feather.icons['edit'].toSvg({ class: 'font-medium-2 text-body' }) +
                            '</a>';
                }              
                if (full['action']['delete']) {
                    action +='<a class=" delete-permission" data-id="' + full['slug'] +
            ...
            const deleteStockyard = document.querySelector('.delete-permission');
